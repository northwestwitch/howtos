...
```
sudo dnf -y module disable container-tools # Should this command fail, fix according this solution: https://techglimpse.com/failed-metadata-repo-appstream-centos-8/
